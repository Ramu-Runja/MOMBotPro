...
public class OAuthController : ControllerBase
{
        ...
        [FromQuery] string? code, [FromQuery] string? state)
    {
        ...
        try
        {
            ...
            // Fetch Zoom user profile for email + Zoom user ID
            ...
            var email  = meDoc.RootElement.TryGetProperty("email", out var em) ? em.GetString() : null;
            var zoomId = meDoc.RootElement.TryGetProperty("id",    out var id) ? id.GetString() : null;
